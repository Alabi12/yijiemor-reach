// src/components/Lessons/AgeAdaptedIntroduction.js
import React, { useState } from 'react';
import { motion } from 'framer-motion';
import './AgeAdaptedIntroduction.css';

const AgeAdaptedIntroduction = ({ data, subject, lesson, userAge, onComplete }) => {
  ...
  return (
    <motion.div 
      className="age-adapted-introduction"
...
export default AgeAdaptedIntroduction;